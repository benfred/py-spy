...
pub trait InterpreterState: Copy {
    ...
    const IS_FREE_THREADED: bool = false;
...
pub trait FrameObject: Copy {
    ...
    /// Reads a local variable address from the localsplus array.
    /// In Python 3.14+, localsplus contains _PyStackRef values which need tag bits masked out.
    /// In earlier versions, it contains raw PyObject* pointers.
    fn read_local_address(raw_value: usize) -> usize {
        // Default implementation: just return the raw value (for Python < 3.14)
        raw_value
    }
}
        ...
        impl CodeObject for $py::PyCodeObject {
            ...
            fn get_line_number(&self, lasti: i32, table: &[u8]) -> i32 {
                ...
                loop {
                    ...
                    // Changed from >= to > : we need to process the entry where bytecode_address == lasti
                    // to get the correct line number for that bytecode offset
                    if bytecode_address > lasti {
                        break;
                    }
                }
...
impl InterpreterState for v3_14_0::PyInterpreterState {
    type ThreadState = v3_14_0::PyThreadState;
    type Object = v3_14_0::PyObject;
...
impl ThreadState for v3_14_0::PyThreadState {
    type FrameObject = v3_14_0::_PyInterpreterFrame;
    type InterpreterState = v3_14_0::PyInterpreterState;
    fn frame_address(&self) -> Option<usize> {
        None
    }
...
impl Object for v3_14_0::PyObject {
    type TypeObject = v3_14_0::PyTypeObject;
    fn ob_type(&self) -> *mut Self::TypeObject {
        self.ob_type as *mut Self::TypeObject
    }
}

impl TypeObject for v3_14_0::PyTypeObject {
    fn name(&self) -> *const ::std::os::raw::c_char {
        self.tp_name
    }
    fn dictoffset(&self) -> isize {
...
Python3Impl!(v3_14_0t);

impl InterpreterState for v3_14_0t::PyInterpreterState {
    type ThreadState = v3_14_0t::PyThreadState;
    type Object = v3_14_0t::PyObject;
    type StringObject = v3_14_0t::PyUnicodeObject;
    type ListObject = v3_14_0t::PyListObject;
    type TupleObject = v3_14_0t::PyTupleObject;
    const HAS_GIL_RUNTIME_STATE: bool = true;
...
impl ThreadState for v3_14_0t::PyThreadState {
    type FrameObject = v3_14_0t::_PyInterpreterFrame;
    type InterpreterState = v3_14_0t::PyInterpreterState;
    fn frame_address(&self) -> Option<usize> {
        None
    }
    fn frame(&self, _addr: Option<usize>) -> *mut Self::FrameObject {
...
impl FrameObject for v3_14_0t::_PyInterpreterFrame {
    type CodeObject = v3_14_0t::PyCodeObject;
    fn code(&self) -> *mut Self::CodeObject {
...
impl Object for v3_14_0t::PyObject {
    type TypeObject = v3_14_0t::PyTypeObject;
    fn ob_type(&self) -> *mut Self::TypeObject {
        self.ob_type as *mut Self::TypeObject
    }
}

impl TypeObject for v3_14_0t::PyTypeObject {
    fn name(&self) -> *const ::std::os::raw::c_char {
        self.tp_name
    }
    fn dictoffset(&self) -> isize {
...
CompactCodeObjectImpl!(v3_14_0t, PyBytesObject, PyUnicodeObject);
