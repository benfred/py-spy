...
impl InterpreterState for v3_14_5::PyInterpreterState {
    type ThreadState = v3_14_5::PyThreadState;
    type Object = v3_14_5::PyObject;
    type StringObject = v3_14_5::PyUnicodeObject;
    type ListObject = v3_14_5::PyListObject;
    type TupleObject = v3_14_5::PyTupleObject;
    const HAS_GIL_RUNTIME_STATE: bool = true;
...
impl ThreadState for v3_14_5::PyThreadState {
    type FrameObject = v3_14_5::_PyInterpreterFrame;
    type InterpreterState = v3_14_5::PyInterpreterState;
    fn frame_address(&self) -> Option<usize> {
        None
    }
    fn frame(&self, _addr: Option<usize>) -> *mut Self::FrameObject {
...
impl FrameObject for v3_14_5::_PyInterpreterFrame {
    type CodeObject = v3_14_5::PyCodeObject;
    fn code(&self) -> *mut Self::CodeObject {
        unsafe { self.f_executable.bits as *mut v3_14_5::PyCodeObject }
    }
    fn lasti(&self) -> i32 {
        let co_code = unsafe { self.f_executable.bits as *const u8 };
        unsafe { (self.instr_ptr as *const u8).offset_from(co_code) as i32 }
...
impl Object for v3_14_5::PyObject {
    type TypeObject = v3_14_5::PyTypeObject;
    fn ob_type(&self) -> *mut Self::TypeObject {
        self.ob_type as *mut Self::TypeObject
    }
}

impl TypeObject for v3_14_5::PyTypeObject {
    fn name(&self) -> *const ::std::os::raw::c_char {
        self.tp_name
    }
    fn dictoffset(&self) -> isize {
...
CompactCodeObjectImpl!(v3_14_5, PyBytesObject, PyUnicodeObject);
