...
impl InterpreterState for v3_14_0::PyInterpreterState {
    ...
    fn threadstate_ptr_ptr(interpreter_address: usize) -> *const *const Self::ThreadState {
        ...
        (interpreter_address + THREADS_OFFSET + THREAD_HEAD_OFFSET) as *const *const Self::ThreadState
    }
    fn modules_ptr_ptr(interpreter_address: usize) -> *const *const Self::Object {
...
impl FrameObject for v3_14_0::_PyInterpreterFrame {
    ...
    fn read_local_address(raw_value: usize) -> usize {
        // In Python 3.14, localsplus contains _PyStackRef values.
        // We need to mask out the tag bits (bottom 3 bits) to get the actual pointer.
        const PY_TAG_BITS: usize = 3;
        raw_value & !PY_TAG_BITS
    }
}
