...
lazy_static! {
    static ref SYSCALLS: HashMap<u32, &'static str> = {
        ...
        m.insert(334, "rseq");
        m.insert(424, "pidfd_send_signal");
        m.insert(425, "io_uring_setup");
        m.insert(426, "io_uring_enter");
        m.insert(427, "io_uring_register");
        m.insert(428, "open_tree");
        m.insert(429, "move_mount");
        m.insert(430, "fsopen");
        m.insert(431, "fsconfig");
        m.insert(432, "fsmount");
        m.insert(433, "fspick");
        m.insert(434, "pidfd_open");
        m.insert(435, "clone3");
        m.insert(437, "openat2");
        m.insert(438, "pidfd_getfd");
        m.insert(439, "faccessat2");
        m.insert(512, "rt_sigaction");
        m.insert(513, "rt_sigreturn");
        m.insert(514, "ioctl");
        m.insert(515, "readv");
        m.insert(516, "writev");
        m.insert(517, "recvfrom");
        m.insert(518, "sendmsg");
        m.insert(519, "recvmsg");
        m.insert(520, "execve");
        m.insert(521, "ptrace");
        m.insert(522, "rt_sigpending");
        m.insert(523, "rt_sigtimedwait");
        m.insert(524, "rt_sigqueueinfo");
        m.insert(525, "sigaltstack");
        m.insert(526, "timer_create");
        m.insert(527, "mq_notify");
        m.insert(528, "kexec_load");
        m.insert(529, "waitid");
        m.insert(530, "set_robust_list");
        m.insert(531, "get_robust_list");
        m.insert(532, "vmsplice");
        m.insert(533, "move_pages");
        m.insert(534, "preadv");
        m.insert(535, "pwritev");
        m.insert(536, "rt_tgsigqueueinfo");
        m.insert(537, "recvmmsg");
        m.insert(538, "sendmmsg");
        m.insert(539, "process_vm_readv");
        m.insert(540, "process_vm_writev");
        m.insert(541, "setsockopt");
        m.insert(542, "getsockopt");
        m.insert(543, "io_setup");
        m.insert(544, "io_submit");
        m.insert(545, "execveat");
        m.insert(546, "preadv2");
        m.insert(547, "pwritev2");
        m
    };
}
                    ...
                    if let Some(tid) = os_thread_id {
                        ...
                        if let Ok(contents) = std::fs::read_to_string(&path) {
                            ...
                            if let Some(syscall) = it.next() {
                                if let Ok(syscall) = &syscall[..].parse::<u32>() {
                                    let name = SYSCALLS.get(syscall).map(|s| format!("{} syscall", s));
                                    let name = name.unwrap_or_else(|| format!("syscall #{}", syscall));
